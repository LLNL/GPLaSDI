...
n_iter = 8000
n_greedy = 2000
max_greedy_iter = n_iter
sindy_weight = 0.1
coef_weight = 1e-6
sample_points = 3 #number of data points to generate at n_iter iterations
