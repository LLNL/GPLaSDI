...
class FNO(BaseModel, name='FNO'):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Adding terms for the latent dynamics losses!
    ...
    def forward(self, x, output_shape=None, **kwargs):
        ...
        # Append the loss terms for the latent dynamics!
        self.sindy_loss = self.fno_blocks.sindy_loss
        self.coefs = self.fno_blocks.coefs
        self.loss_coefs = self.fno_blocks.loss_coef
        # if self.domain_padding is not None:
